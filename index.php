      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
                <a href="#loginForm" class="nav-link" data-toggle="modal">Login</a>
            </li>
            <li class="nav-item">
                <a href="#registrationForm" class="nav-link" data-toggle="modal">Register</a>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div class="container h-100">
        <div class="row h-75">
          <div class="col align-self-center text-center">
            ...
            <button type="button" class="btn btn-primary btn-lg">Schedule an Appointment</button>
          </div>
        </div>
      </div>
    </div>
